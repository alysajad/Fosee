...
class UserLoginForm(forms.Form):
    ...
    username = forms.CharField(max_length=32,
                               widget=forms.TextInput(attrs={'class': 'fossee-input', 'placeholder': 'Username'}))

    password = forms.CharField(max_length=32,
                               widget=forms.PasswordInput(attrs={'class': 'fossee-input', 'placeholder': 'Password'}))
    ...
    class Meta:
        ...
        widgets = {
            'date': forms.DateInput(attrs={
                'class': 'datepicker fossee-input', 'placeholder': 'Workshop Date'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.visible_fields():
            if isinstance(field.field.widget, forms.Textarea):
                field.field.widget.attrs['class'] = 'fossee-textarea'
                field.field.widget.attrs['rows'] = 6
            elif isinstance(field.field.widget, forms.Select):
                field.field.widget.attrs['class'] = 'fossee-select'
            else:
                field.field.widget.attrs['class'] = 'fossee-input'
...
class ProfileForm(forms.ModelForm):
    ...
    first_name = forms.CharField(max_length=30, widget=forms.TextInput(
                    {'class': "fossee-input", 'placeholder': "First Name"}))
    last_name = forms.CharField(max_length=30, widget=forms.TextInput(
                    {'class': "fossee-input", 'placeholder': "Last Name"}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['institute'].widget.attrs.update(
            {'class': "fossee-input", 'placeholder': 'Institute'}
        )
        ...
        self.fields['phone_number'].widget.attrs.update(
            {'class': "fossee-input", 'placeholder': 'Phone Number'}
        )
        self.fields['position'].widget.attrs.update(
            {'class': "fossee-input", 'placeholder': 'Position'}
        )
        self.fields['location'].widget.attrs.update(
            {'class': "fossee-input", 'placeholder': 'Location'}
        )
